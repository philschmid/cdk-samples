...
class SageMakerEndpointConstruct(cdk.Construct):
    def __init__(
        ...
        *,
        ...
        model_name = f'{huggingface_model.replace("_","-").replace("/","--")}-model'
        endpoint_config_name = f'{huggingface_model.replace("_","-").replace("/","--")}-config-ep'
        endpoint_name = f'{huggingface_model.replace("_","-").replace("/","--")}-ep'
