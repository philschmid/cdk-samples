...
from eks_cluster_with_vpc_and_ingress.eks_cluster_with_vpc_and_ingress_stack import EksClusterWithVpcAndIngressStack
...
app = core.App()
EksClusterWithVpcAndIngressStack(app, "EksClusterWithVpcAndIngressStack", env=my_environment)
